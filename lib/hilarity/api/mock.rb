require 'hilarity/api/mock/addons'
require 'hilarity/api/mock/apps'
require 'hilarity/api/mock/attachments'
require 'hilarity/api/mock/collaborators'
require 'hilarity/api/mock/config_vars'
require 'hilarity/api/mock/domains'
require 'hilarity/api/mock/features'
require 'hilarity/api/mock/keys'
require 'hilarity/api/mock/login'
require 'hilarity/api/mock/logs'
require 'hilarity/api/mock/processes'
require 'hilarity/api/mock/releases'
require 'hilarity/api/mock/stacks'
require 'hilarity/api/mock/user'
